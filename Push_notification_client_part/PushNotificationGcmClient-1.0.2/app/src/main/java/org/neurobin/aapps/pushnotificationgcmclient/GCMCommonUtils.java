...
public class GCMCommonUtils {
    ...
    public static final String SERVER_URL = "http://10.0.2.2/PushNotificationServer-1.0.2/";
    ...
    public static final String DISPLAY_MESSAGE_ACTION = "org.neurobin.aapps.pushnotificationclient";
